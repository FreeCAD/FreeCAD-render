...
def _write_material_carpaint(name, material):
    ...
    # TODO Move search path to render function
    snippet = """
        <search_path>
            {s}
        </search_path>
    ...
    <shader_group name="{n}_group">
        <shader layer="FlakesVoronoi" type="shader" name="as_voronoi3d">
            <parameter name="in_featuresMode" value="int 0" />
            <parameter name="in_metric" value="int 0" />
            <parameter name="in_density" value="float 0.00125" />
        </shader>
        <shader layer="FlakesNormal" type="shader" name="as_bump">
            <parameter name="in_mode" value="string Normal Map" />
            <parameter name="in_normal_map_weight" value="float 0.05" />
        </shader>
        <shader layer="FlakesFresnel" type="shader" name="as_fresnel">
        ...
        <shader layer="Flakes+Reflects" type="shader" name="as_blend_shader">
        ...
        <connect_shaders src_layer="FlakesVoronoi" src_param="out_outColor"
                         dst_layer="FlakesNormal" dst_param="in_normal_map" />
        <connect_shaders src_layer="FlakesNormal" src_param="out_normal"
                         dst_layer="Flakes" dst_param="in_bump_normal" />
        <connect_shaders src_layer="FlakesFresnel" src_param="out_alpha"
                         dst_layer="Flakes+Reflects" dst_param="in_weight1" />
        <connect_shaders src_layer="Reflects" src_param="out_outColor"
                         dst_layer="Flakes+Reflects" dst_param="in_color" />
        <connect_shaders src_layer="Flakes" src_param="out_outColor"
                         dst_layer="Flakes+Reflects" dst_param="in_color1" />
    ...
    <shader_group name="{n}_group">
        <shader layer="MasterMix" type="shader" name="as_standard_surface">
            <parameter name="in_color" value="color {c.r} {c.g} {c.b}" />
            <parameter name="in_specular_color" value="color {x.r} {x.g} {x.b}" />
            ...
            <parameter name="in_coating_absorption" value="color {k.r} {k.g} {k.b}" />
            <parameter name="in_coating_reflectivity" value="float 0.8" />
            <parameter name="in_coating_depth" value="float 0.2" />
    ...
    return snippet.format(
        ...
        k=RGB(0.9, 0.9, 0.9),  # Coat
        x=RGB(0.4, 1.0, 0.1),  # FX
    )
