...
# - The script has to be executed within the `Render/resources/translations` directory.
...
# - Once done, download the translated files, copy them to `Render/resources/translations`
...
update_locale() {
	...
	FILES="../../*.py ../../../InitGui.py ../ui/Render{Material,Settings}.ui"
